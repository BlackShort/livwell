...
class SearchPage extends StatelessWidget {
  ...
  SearchPage({super.key, this.onOrganizationTap, this.onOpportunityTap});
          ...
          child: Row(
            children: [
              CircleAvatar(
                ...
                radius: 24,
                child: Icon(iconData, color: AppPallete.white),
              ),
              const SizedBox(width: 16),
              Expanded(
                child: Column(
              ...
              Container(
                ...
                child:
                    opportunity['imageUrl'] == null
                        ? const Center(
                          child: Icon(Icons.event, color: AppPallete.white),
                        )
                        : null,
              ),
              const SizedBox(width: 16),
